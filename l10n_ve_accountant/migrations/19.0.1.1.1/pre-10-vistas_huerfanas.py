"""Borra las vistas que l10n_ve_accountant declaraba en 17 y en 19 ya no.
...
ORPHAN_VIEWS = [
    "binaural_accountant_inherit_report_payment_receipt_document",
    "res_config_settings_view_inherit_l10n_ve_accountant",
    "view_invoice_tree",
]
