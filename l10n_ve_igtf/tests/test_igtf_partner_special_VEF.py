...
@tagged("igtf_ve_nuevo1", "igtf_run", "-at_install", "post_install")
class TestIGTFNEW(IGTFTestCommon): 
    ...
    def test01_payment_from_invoice_with_igtf_journal(self):
        ...
        expected_lines = [
            {'account': self.account_bank, 'foreign_debit': payment_amount, 'foreign_credit': 0.0},
            {'account': self.acc_receivable, 'foreign_debit': 0.0, 'foreign_credit': cxc_credit_amount},
            {'account': self.acc_igtf_cli, 'foreign_debit': 0.0, 'foreign_credit': expected_igtf},
        ]
    ...
    def test02_payment_from_invoice_with_igtf_journal(self):
        ...
        _logger.info(f"Monto segundo pago en VES: {payment_2.amount}")
        
        expected_lines_2 = [
            {'account': self.account_bank, 'debit': amount_2, 'credit': 0.0},
            {'account': self.acc_receivable, 'debit': 0.0, 'credit': amount_2},
        ]
        ...
        _logger.info("test02 completamente superado (pago parcial USD + pago final BS).")
    ...
    def test03_payment_from_invoice_with_igtf_journal(self):
        ...
        # 1264.86 * 201.47 = 254831.34 restante
        ...
        expected_lines = [
            {'account': self.account_bank, 'debit': payment_amount / inverse_rate, 'credit': 0.0},
            {'account': self.acc_receivable, 'debit': 0.0, 'credit': cxc_credit_amount /inverse_rate},
            {'account': self.acc_igtf_cli, 'debit': 0.0, 'credit': 16265.881920030806},
        ]
        self._assert_move_lines_equal(payment_move, expected_lines)
        ...
        expected_lines = [
            {'account': self.acc_receivable, 'debit': 254832.1542, 'credit':0.0 },
            {'account': self.advance_cust_acc, 'debit': 0.0, 'credit': 254832.1542},
        ]
        ...
        expected_lines = [
            ...
            {'account': self.acc_receivable, 'debit': 0.0, 'credit': 950.00 / inverse_rate},
            
            {'account': self.acc_igtf_cli, 'debit': 0.0, 'credit':28.50 / inverse_rate},
            {'account': self.advance_cust_acc, 'debit': (950.00 + igtf_cross) / inverse_rate, 'credit': 0.0},
        ]
        ...
        expected_lines = [
            {
            ...
            
             {
                'account': self.acc_igtf_cli,  
                'debit': 0.0,
                'credit': igtf_expected / invoice.foreign_inverse_rate,       
            },
            {
                'account': self.acc_receivable,
                'debit': 0.0,
                'credit': (2700.00 - igtf_expected) / invoice.foreign_inverse_rate,   
            },
        ]
    ...
    def test14_payment_from_invoice_with_igtf_journal(self):
        ...
        expected_lines = [
            {
                'account': self.account_bank,      
                'debit': advance_amount / invoice.foreign_inverse_rate ,       
                'credit': 0.0,
            },
            ...
            },
            {
                'account': self.acc_receivable,
                'debit': 0.0,
                'credit': (advance_amount / invoice.foreign_inverse_rate) - igtf_expected,   
            },
        ]
    ...
    def test15_payment_from_invoice_with_igtf_journal(self):
        ...
        expected_lines = [
...

            {
                'account': self.acc_receivable,
                'debit': 0.0,
                'credit': (last_advance / invoice.foreign_inverse_rate) - (igtf_expected / invoice.foreign_inverse_rate),   
            },
        ]
    ...
    def test16_payment_from_invoice_with_igtf_journal_desconciliation(self):
        ...
        expected_lines = [
            {
                'account': self.account_bank,      
                'debit': payment_amount / invoice.foreign_inverse_rate,       
                'credit': 0.0,
            },
        ...
        expected_lines = [
           ...
           
            {
            ...
            },
             {
                'account': self.acc_igtf_cli,  
                'debit': 0.0,
                'credit': expected_igtf / invoice.foreign_inverse_rate,       
            },
        ]
