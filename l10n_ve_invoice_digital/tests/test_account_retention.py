...
class TestAccumulatedRate(TransactionCase):
    def setUp(self):
        ...
        # O19: l10n_ve_accountant exige cuenta en cada linea de metodo de pago
        # de un diario bancario; Odoo las autocrea sin payment_account_id.
        # Se usa el escape de bootstrap que la propia restriccion contempla.
        self.iva_journal = self.env["account.journal"].with_context(install_mode=True).create({
        ...
        self.islr_supplier_retention_journal = self.env["account.journal"].with_context(install_mode=True).create({
    ...
    def test_46_prepare_detail_lines_monto_exento(self):
        ...
        retention.action_post()
        # base_currency_is_vef=True fuerza la lectura de base_amount_currency
        # (montos en la moneda del documento) dentro de tax_totals['subtotals'],
        # para no depender de como se propagan los campos foreign_* de linea
        # hacia tax_totals en facturas de compra.
        retention.base_currency_is_vef = True
