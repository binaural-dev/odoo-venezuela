"""Borra las vistas que l10n_ve_stock_account declaraba en 17 y en 19 ya no.
...
ORPHAN_VIEWS = [
    "res_config_settings_view_form_stock_inherit",
    "stock_view_picking_form",
    "view_res_config_settings_l10n_ve_stock_account",
]
