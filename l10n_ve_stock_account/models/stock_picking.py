...
class StockPicking(models.Model):
    ...
    def _set_guide_number(self):
        # Idempotent, mirrors the 'do not overwrite' guard on
        # _assign_control_numbers(): if _action_done() ever runs a second
        # time on the same picking, this must not burn a second correlativo
        # and orphan the first one.
        for picking in self:
