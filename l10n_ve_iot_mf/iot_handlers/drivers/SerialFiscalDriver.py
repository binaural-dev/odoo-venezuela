...
class SerialFiscalDriver(SerialDriver):
    ...
    def prepare_invoice_data(self, invoice):
        ...
        try:
            ...
            _logger.warning(
                "[INV_TRACE] payment_lines=%s change_lines=%s closing_method=%s",
                payment_lines,
                change_lines,
                closing_method,
            )
            ...
            for item in payment_lines:
                ...
                # NO enviar métodos de cambio como pagos fiscales: la máquina
                # calcula el cambio automáticamente con el excedente del pago.
                # Solo enviamos comandos 2XX de pagos positivos reales.
