...
export class TaxTotalsComponent extends Component {
    ...
    _computeTotalsFormat() {
        ...
        for (let subtotal_title of this.totals.subtotals_order) {
            ...
            let group = this.totals.groups_by_foreign_subtotal[subtotal_title];
            for (let i in group) {
        ...
        for (let group_name of Object.keys(this.totals.groups_by_foreign_subtotal)) {
            let group = this.totals.groups_by_foreign_subtotal[group_name];
            for (let i in group) {
