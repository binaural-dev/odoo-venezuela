...
- [x] 2.3 Regresión: venta pagada justa (sin vuelto) sigue con su alterno correcto
- [x] 2.4 Reproducir la variante pagando en USD (EFE $) por encima del total, para confirmar el síntoma de la factura del ticket
- [x] 2.5 Cierre de sesión de una orden NO facturada con vuelto → asiento cruzado con alterno correcto
