...
patch(PosStore.prototype, {
  ...
  compute_all(taxes, price_unit, quantity, currency_rounding, handle_price_include = true) {
    ...
    var recompute_base = function(base_amount, incl_tax_amounts) {
      ...
      if (company.country && company.country.code === "IN") {
        ...
        for (const [i, tax_factor] of incl_tax_amounts.percent_taxes) {
          const tax_amount = round_pr(base_amount * tax_factor / (100 + percent_amount), 0);
    ...
    var base = round_pr(price_unit * quantity, 0);
    ...
    taxes.reverse().forEach(function(tax) {
      ...
      tax_amount = round_pr(tax_amount, 0);
      ...
      taxes_vals.push({
        ...
        base: sign * round_pr(tax_base_amount, 0),
      });
    ...
    return {
      taxes: taxes_vals,
      total_excluded: sign * round_pr(total_excluded, 0),
      total_included: sign * round_pr(total_included, 0),
    };
  },
