...
/**
 ...
 currency_id field.
 **/
export class ForeignTaxTotalsComponent extends Component {
    setup() {
        super.setup();
...
ForeignTaxTotalsComponent.template = "binaural_invoice.ForeignTaxTotalsField";
ForeignTaxTotalsComponent.components = { TaxGroupComponent };
ForeignTaxTotalsComponent.props = {
    ...standardFieldProps,
};

registry.category("fields").add("account-foreign-tax-totals-field", ForeignTaxTotalsComponent);