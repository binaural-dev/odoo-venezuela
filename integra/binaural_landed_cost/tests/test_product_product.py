...
class TestProduct(TransactionCase):
    ...
    def test_compute_latest_standard_price(self):
        # Test that the latest standard price of the product template is propagated to the product variants
    ...
    def test_get_variants_are_active(self):
        ...
        self.assertTrue(self.env['product.product'].get_variants_are_active())
        ...
        self.assertFalse(self.env['product.product'].get_variants_are_active())