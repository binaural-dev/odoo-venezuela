...
class StockQuantityHistoryInh(models.TransientModel):
    ...
    def generate_report(self):
        ...
        product_ids_a = product_ids._compute_quantities_dict(
            lot_id=False, owner_id=False, package_id=False, to_date=inventory_datetime, location=warehouse_search_id
        )
        ...
        return self.env.ref("binaural_stock.inventory_valuation_report").report_action(
            [], data=data
        )
