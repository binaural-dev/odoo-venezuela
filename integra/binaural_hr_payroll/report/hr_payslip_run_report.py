...
class HrPayslipRunReport(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return {
            ...
            "docs": docs,
            "data": data,
            "get_totals_per_line": self._get_totals_per_line(docs, total_field),
            "get_total_net": self._get_total_net(docs, total_field),
    ...
    def _get_totals_per_line(self, docs, total_field):
        ...
        categories_not_to_sum = ["DEV", "NET", "OC", "OCV", "DEVVAC"]
        for line in (
    ...
    def _get_total_net(self, docs, total_field):
        return sum(
            docs.slip_ids.mapped("line_ids")
