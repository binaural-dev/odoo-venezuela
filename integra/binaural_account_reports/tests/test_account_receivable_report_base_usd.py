...
class TestAccountReceivableReportBinauralBaseVef(TestAccountReportsCommonBinaural):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        _logger.warning("Account moves before test: %s", cls.env["account.move"].search([]).read(["foreign_rate"]))
        cls.foreign_currency.rate_ids.unlink()
        cls.foreign_currency.rate_ids = [
            Command.create({"name": "2016-01-01", "company_rate": 25}),
        ]
...
#         (move_3 + move_4).action_post()
    ...
    def test_aged_receivable_report_base_vef(self):
        ...
        #     [   0,                                 1,       4,          5,          6,          7,          8,          9,          10],
        #     [
        #         ('Aged Receivable',               '',       6,          6,          6,          36,        18,          6,          78),
        #         ('partner_a',                     '',       4,          4,          4,          24,        12,          4,          52),
        #         ('INV/2016/00002',      '01/01/2016',      '',         '',         '',          '',        '',          4,          ''),
        #         ('INV/2016/00002',      '10/04/2016',      '',         '',         '',          '',         4,         '',          ''),
        #         ('INV/2016/00002',      '10/05/2016',      '',         '',         '',          '',         8,         '',          ''),
        #         ('INV/2016/00001',      '11/03/2016',      '',         '',         '',          20,        '',         '',          ''),
        #         ('INV/2016/00002',      '11/03/2016',      '',         '',         '',           4,        '',         '',          ''),
        #         ('INV/2016/00002',      '12/03/2016',      '',         '',          4,          '',        '',         '',          ''),
        #         ('INV/2016/00002',      '01/02/2017',      '',          4,         '',          '',        '',         '',          ''),
        #         ('INV/2016/00002',      '02/01/2017',       4,         '',         '',          '',        '',         '',          ''),
        #         ('Total partner_a',               '',       4,          4,          4,          24,        12,          4,          52),
        #         ('partner_b',                     '',       2,          2,          2,          12,         6,          2,          26),
        #         ('Total Aged Receivable',         '',       6,          6,          6,          36,        18,          6,          78),
        #     ],
